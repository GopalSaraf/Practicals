...
public class Account extends Customer {
     ...
     * This will print menu and according to user's option, it will create that
     * account in bank.
     */
    public static void createAccount() {
        ...
        char accountType;
        Account acc = null;
        System.out.print(CREATE_ACCOUNT_MENU);
        ...
        if (acc != null)
            acc.setData(); // Taking input from user
    ...
    public void generatePassword() {
        ...
        while (!Valid.isValidPassword(passwordStr)) {
            System.out.print(ENTER_VALID_PASSWORD);
            passwordStr = sc.next();
        }
     ...
     * This will take input and set {@link #forgotPasswordIDs} and
     * {@link #forgotPasswordAns}.
    ...
    public void updateAccount() {
        char option;
        System.out.print(UPDATE_ACCOUNT_MENU);
        ...
        switch (option) {
            ...
            case 'b' -> {
                setAge();
                System.out.println(AGE_UPDATED);
            }
            case 'c' -> {
                setMobileNo();
                System.out.println(MOBILE_NUMBER_UPDATED);
            }
            case 'd' -> System.out.println(UPDATE_SKIP);
            default -> System.out.println(INCORRECT_OPTION);
