...
import CustomerHelper.Transactions.Transaction;
...
public final class TransactionsDatabase {
    ...
    public static void addTransaction(int accountNo, String dateTime, String transaction, double depositAmount,
        ...
        try {
            ...
            while ((stream = br.readLine()) != null) sb.append(stream).append("\n");
            br.close();
        ...
        try {
            ...
            while ((stream = br.readLine()) != null) {
                ...
                if (accountNo == Integer.parseInt(data[transactionsColumns.get("accountNo")]) &&
                        (!forCustomer || Objects.equals(data[transactionsColumns.get("status")], Transaction.SUCCESS))) {
                    transactions.add(
                            new Transaction(
