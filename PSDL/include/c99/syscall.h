...
#define _syscall(n, ...) _syscall_##n(__VA_ARGS__)
#define _syscall_n(...) __syscall(n, __VA_ARGS__)
#define _syscall_nr(...) __syscall(nr, __VA_ARGS__)
#define _syscall0(n) _syscall(n)
#define _syscall1(n,a) _syscall(n,__scc(a))
#define _syscall2(n,a,b) _syscall(n,__scc(a),__scc(b))
#define _syscall3(n,a,b,c) _syscall(n,__scc(a),__scc(b),__scc(c))
#define _syscall4(n,a,b,c,d) _syscall(n,__scc(a),__scc(b),__scc(c),__scc(d))
#define _syscall5(n,a,b,c,d,e) _syscall(n,__scc(a),__scc(b),__scc(c),__scc(d),__scc(e))
#define _syscall6(n,a,b,c,d,e,f) _syscall(n,__scc(a),__scc(b),__scc(c),__scc(d),__scc(e),__scc(f))
#define _syscall7(n,a,b,c,d,e,f,g) _syscall(n,__scc(a),__scc(b),__scc(c),__scc(d),__scc(e),__scc(f),__scc(g))
...
#ifdef SYSCALL_GO_DIRECT
#define __syscall(...) __SYSCALL_DISP(_syscall,__VA_ARGS__)
#else
