...
volatile       unsigned char	SSPCON2		__at(0x091);
...
volatile	unsigned char	VRCON		__at(0x097);
volatile       unsigned char	TXSTA		__at(0x098);
volatile	unsigned char	SPBRG		__at(0x099);
volatile	unsigned char	SPBRGH		__at(0x09A);
volatile       unsigned char	PWM1CON		__at(0x09B);
volatile       unsigned char	ECCPAS		__at(0x09C);
volatile unsigned char	PSTRCON		__at(0x09D);
volatile       unsigned char	ADRESL		__at(0x09E);
volatile	unsigned char	ADCON1		__at(0x09F);
volatile       unsigned char	WDTCON		__at(0x105);
volatile       unsigned char	CM1CON0		__at(0x107);
volatile       unsigned char	CM2CON0		__at(0x108);
volatile       unsigned char	CM2CON1		__at(0x109);
...
volatile       unsigned char	SRCON		__at(0x185);
volatile       unsigned char	BAUDCTL		__at(0x187);
volatile	unsigned char	ANSEL		__at(0x188);
volatile	unsigned char	ANSELH		__at(0x189);
...
volatile       __bit	ULPWUIF		__at((0x00D*8)+2);
volatile       __bit	BCLIF		__at((0x00D*8)+3);
...
volatile	__bit	ADCS0		__at((0x01F*8)+6);
volatile	__bit	ADCS1		__at((0x01F*8)+7);
...
volatile	__bit	ULPWUIE		__at((0x08D*8)+2);
volatile	__bit	BCLIE		__at((0x08D*8)+3);
...
volatile	__bit	SEN		__at((0x091*8)+0);
volatile       __bit	RSEN		__at((0x091*8)+1);
volatile       __bit	PEN		__at((0x091*8)+2);
volatile       __bit	RCEN		__at((0x091*8)+3);
volatile       __bit	ACKEN		__at((0x091*8)+4);
volatile       __bit	ACKDT		__at((0x091*8)+5);
volatile       __bit	ACKSTAT		__at((0x091*8)+6);
volatile	__bit	GCEN		__at((0x091*8)+7);
...
volatile	__bit	VR0		__at((0x097*8)+0);
volatile	__bit	VR1		__at((0x097*8)+1);
volatile	__bit	VR2		__at((0x097*8)+2);
volatile	__bit	VR3		__at((0x097*8)+3);
volatile	__bit	VRSS		__at((0x097*8)+4);
volatile	__bit	VRR		__at((0x097*8)+5);
volatile	__bit	VROE		__at((0x097*8)+6);
volatile	__bit	VREN		__at((0x097*8)+7);
...
volatile       __bit	PDC0		__at((0x09B*8)+0);
volatile       __bit	PDC1		__at((0x09B*8)+1);
volatile       __bit	PDC2		__at((0x09B*8)+2);
volatile       __bit	PDC3		__at((0x09B*8)+3);
volatile       __bit	PDC4		__at((0x09B*8)+4);
volatile       __bit	PDC5		__at((0x09B*8)+5);
volatile       __bit	PDC6		__at((0x09B*8)+6);
volatile       __bit	PRSEN		__at((0x09B*8)+7);

/* Definitions for ECCPAS register */
volatile	__bit	PSSBD0		__at((0x09C*8)+0);
volatile	__bit	PSSBD1		__at((0x09C*8)+1);
volatile	__bit	PSSAC0		__at((0x09C*8)+2);
volatile	__bit	PSSAC1		__at((0x09C*8)+3);
volatile	__bit	ECCPAS0		__at((0x09C*8)+4);
volatile	__bit	ECCPAS1		__at((0x09C*8)+5);
volatile	__bit	ECCPAS2		__at((0x09C*8)+6);
volatile       __bit	ECCPASE		__at((0x09C*8)+7);

/* Definitions for PSTRCON register */
volatile __bit	STRA		__at((0x09D*8)+0);
volatile __bit	STRB		__at((0x09D*8)+1);
volatile __bit	STRC		__at((0x09D*8)+2);
volatile __bit	STRD		__at((0x09D*8)+3);
volatile __bit	STRSYNC		__at((0x09D*8)+4);

/* Definitions for ADCON1 register */
volatile	__bit	VCFG0		__at((0x09F*8)+4);
volatile	__bit	VCFG1		__at((0x09F*8)+5);
...
volatile	__bit	C1CH0		__at((0x107*8)+0);
volatile	__bit	C1CH1		__at((0x107*8)+1);
volatile	__bit	C1R		__at((0x107*8)+2);
volatile	__bit	C1POL		__at((0x107*8)+4);
volatile	__bit	C1OE		__at((0x107*8)+5);
volatile       __bit	C1OUT		__at((0x107*8)+6);
volatile	__bit	C1ON		__at((0x107*8)+7);

/* Definitions for CM2CON0 register */
volatile	__bit	C2CH0		__at((0x108*8)+0);
volatile	__bit	C2CH1		__at((0x108*8)+1);
volatile	__bit	C2R		__at((0x108*8)+2);
volatile	__bit	C2POL		__at((0x108*8)+4);
volatile	__bit	C2OE		__at((0x108*8)+5);
volatile       __bit	C2OUT		__at((0x108*8)+6);
volatile	__bit	C2ON		__at((0x108*8)+7);

/* Definitions for CM2CON1 register */
volatile	__bit	C2SYNC		__at((0x109*8)+0);
volatile	__bit	T1GSS		__at((0x109*8)+1);
volatile	__bit	C2RSEL		__at((0x109*8)+4);
volatile	__bit	C1RSEL		__at((0x109*8)+5);
volatile       __bit	MC2OUT		__at((0x109*8)+6);
volatile       __bit	MC1OUT		__at((0x109*8)+7);

/* Definitions for SRCON register */
volatile	__bit	FVREN		__at((0x185*8)+0);
volatile       __bit	PULSR		__at((0x185*8)+2);
volatile       __bit	PULSS		__at((0x185*8)+3);
volatile	__bit	C2REN		__at((0x185*8)+4);
volatile	__bit	C1SEN		__at((0x185*8)+5);
volatile	__bit	SR0		__at((0x185*8)+6);
volatile	__bit	SR1		__at((0x185*8)+7);

/* Definitions for BAUDCTL register */
volatile       __bit	ABDEN		__at((0x187*8)+0);
volatile       __bit	WUE		__at((0x187*8)+1);
volatile	__bit	BRG16		__at((0x187*8)+3);
volatile       __bit	SCKP		__at((0x187*8)+4);
volatile       __bit	RCIDL		__at((0x187*8)+6);
volatile       __bit	ABDOVF		__at((0x187*8)+7);

/* Definitions for ANSEL register */
volatile	__bit	ANS0		__at((0x188*8)+0);
volatile	__bit	ANS1		__at((0x188*8)+1);
volatile	__bit	ANS2		__at((0x188*8)+2);
volatile	__bit	ANS3		__at((0x188*8)+3);
volatile	__bit	ANS4		__at((0x188*8)+4);
#if defined(_16F884) || defined(_16F887)
volatile	__bit	ANS5		__at((0x188*8)+5);
volatile	__bit	ANS6		__at((0x188*8)+6);
volatile	__bit	ANS7		__at((0x188*8)+7);
#endif

/* Definitions for ANSELH register */
volatile	__bit	ANS8		__at((0x189*8)+0);
volatile	__bit	ANS9		__at((0x189*8)+1);
volatile	__bit	ANS10		__at((0x189*8)+2);
volatile	__bit	ANS11		__at((0x189*8)+3);
volatile	__bit	ANS12		__at((0x189*8)+4);
volatile	__bit	ANS13		__at((0x189*8)+5);
